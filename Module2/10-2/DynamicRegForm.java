...
public class DynamicRegForm extends Test
{
                               ...
                               if (nameField.getText().equals("")) 
                               {
                                ...
                                else 
                                {
	                               ...
	                               //Executing MySQL Update Query 
	                                ...
	                                String string = serialNo++ +","+String.valueOf(rstLast.getString(1))+","+rstLast.getString(2)+","+rstLast.getString(3)+","+rstLast.getString(4)+","+rstLast.getString(5); 
