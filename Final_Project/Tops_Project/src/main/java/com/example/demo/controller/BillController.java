...
public class BillController {
    ...
    @GetMapping("/bill/{id}")
    public String billPage(@PathVariable Integer id,
                           Model model) {
    ...
    public void printBill(@PathVariable int id,
        ...
        document.add(
                new Paragraph(
                        "Mobile Inventory Billing System",
                        boldFont
                )
        );
